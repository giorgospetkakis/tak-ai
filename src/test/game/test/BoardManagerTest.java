...
public class BoardManagerTest {
  ...
  public void setup() {
    ...
    BoardManager.add(b1, s1, BoardManager.getCell(b1, 0, 0));
    BoardManager.add(b1, s2, BoardManager.getCell(b1, 0, 0));
    BoardManager.add(b1, s3, BoardManager.getCell(b1, 0, 1));
    BoardManager.add(b1, s4, BoardManager.getCell(b1, 0, 1));
    BoardManager.add(b1, s5, BoardManager.getCell(b1, 0, 0));
    BoardManager.add(b1, c, BoardManager.getCell(b1, 1, 0));
  }
  ...
  public void moveStackTest() {
    ...
    BoardManager.move(BoardManager.getCell(b1, 0, 1), BoardManager.getCell(b1, 0, 0), 2);
    ...
    BoardManager.move(BoardManager.getCell(b1, 1, 0), BoardManager.getCell(b1, 0, 0), 1);
